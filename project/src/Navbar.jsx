    ...
    <header className="shadow mb-2">
      <div className="relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 md:mx-auto md:flex-row md:items-center">
        ...
        <Link to="/" className="flex items-center whitespace-nowrap text-2xl font-black">
          ...
          <span className="text-black">The Kart</span>
        </Link>
        ...
        >
          <ul className="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
            <li className="text-gray-600 hover:text-blue-600 md:mr-6">
            ...
            <li className="relative text-gray-600 hover:text-blue-600 md:mr-6 flex items-center">
